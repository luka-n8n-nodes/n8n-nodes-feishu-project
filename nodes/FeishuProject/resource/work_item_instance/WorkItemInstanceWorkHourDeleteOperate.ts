...
const WorkItemInstanceWorkHourDeleteOperate: ResourceOperations = {
	name: '删除实际工时',
	value: 'work_item_instance:work_hour_delete',
	order: 140,
	options: [
...
export default WorkItemInstanceWorkHourDeleteOperate;
